...
DATA_PATHS = {
    ...
    'videomatte': {
        'train': '../matting-data/PanasonicMatte/train', #../matting-data/VideoMatte240K_JPEG_SD/train',
        'valid': '../matting-data/PanasonicMatte/valid', #../matting-data/VideoMatte240K_JPEG_SD/valid'
    },
    'imagematte': {
